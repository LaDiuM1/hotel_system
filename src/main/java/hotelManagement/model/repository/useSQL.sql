...
values
    ...
    ('00000000', '$2a$10$Z61RSnFD2/gSz3m8K72ipOiaae7.CYR7HJlCiYIavLoMk.eoUnOtG', '관리자 계정 주소', '2016-06-16', '131', '07', '사장');


update roomresv set rrstartdate = date_format(rrcheckin, '%Y-%m-%d') where rrno = rrno;
update roomresv set rrenddate = date_format(rrcheckout, '%Y-%m-%d') where rrno = rrno;
delete from lresv where lname is null;
