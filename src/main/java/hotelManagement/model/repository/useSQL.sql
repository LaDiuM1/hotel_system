...
/* 직원 테이블 */
insert into employee (eno, epwd, eaddress, erank,mno_fk,dcode_fk,pname_fk)
values
    ('23010001','asdopkopk','경기도 안산시 단원구 중앙동',1,101,'01','사원'),
    ('23020002', 'qwertyui', '서울특별시 강남구 역삼동', 2, 102, '02', '주임'),
    ('23030003', 'zxcvbnm', '인천광역시 남동구 도화동', 1, 103, '03', '대리'),
    ('23040004', '12345678', '대구광역시 수성구 만촌동', 2, 104, '04', '과장'),
    ('23050005', 'abcdefg', '부산광역시 해운대구 우동', 1, 105, '05', '차장'),
    ('23060006', '87654321', '광주광역시 서구 치평동', 3, 106, '06', '부장'),
    ('23070007', 'qazwsx', '대전광역시 서구 둔산동', 4, 107, '07', '이사'),
    ('23050008', 'poiuytrew', '울산광역시 남구 삼산동', 2, 108, '05', '과장'),
    ('23050009', 'mnbvcxz', '경기도 수원시 영통구 매탄동', 1, 109, '05', '사원'),
    ('23040010', 'plmoknij', '서울특별시 종로구 인사동', 2, 110, '04', '주임'),
    ('23010011', 'ytrewq', '인천광역시 부평구 부평동', 1, 111, '01', '대리'),
    ('23010012', '0987654321', '대구광역시 달서구 이곡동', 2, 112, '01', '과장'),
    ('23030013', 'vbnmasdf', '부산광역시 사하구 하단동', 2, 113, '03', '차장'),
    ('23050014', '1q2w3e4r', '광주광역시 북구 우치로1가', 3, 114, '05', '부장'),
    ('23060015', 'zaq1xsw2', '대전광역시 유성구 구즉동', 3, 115, '06', '이사'),
    ('23040016', 'cde3vfr4', '울산광역시 동구 성남동', 2, 116, '04', '과장'),
    ('23070017', '7y6t5r4e', '경기도 화성시 병점동', 1, 117, '07', '사원'),
    ('23070018', 'u8i9o0p-', '서울특별시 송파구 거여동', 1, 118, '07', '주임'),
    ('23050019', 'asdfghjk', '인천광역시 서구 검단동', 1, 119, '05', '대리'),
    ('23040020', 'zxvbnm123', '대구광역시 달서구 신당동', 2, 120, '04', '과장'),
    ('23040021', 'qweasdzxc', '부산광역시 중구 남포동', 1, 121, '04', '차장'),
    ('23030022', '1qaz2wsx', '광주광역시 남구 대촌동', 3, 122, '03', '부장'),
    ('23050023', 'poiuyt123', '대전광역시 대덕구 송촌동', 3, 123, '05', '이사'),
    ('23010024', 'mko0nji9', '울산광역시 남구 삼산로', 3, 124, '01', '사원'),
    ('23030025', 'zxcvbn4321', '경기도 용인시 수지구 풍덕천동', 2, 125, '03', '사원'),
    ('23010026', '0987poiuy', '서울특별시 강동구 천호동', 1, 126, '01', '주임'),
    ('23010027', 'mnbvcx987', '인천광역시 계양구 작전동', 1, 127, '01', '대리'),
    ('23030028', 'qwerasdf', '대구광역시 수성구 수성동', 2, 128, '03', '과장'),
    ('23010029', '1qaz2wsx', '부산광역시 사상구 괘법동', 4, 129, '01', '사장'),
    ('23010030', 'plmoknij', '광주광역시 동구 서석동', 2, 130, '01', '부장');
