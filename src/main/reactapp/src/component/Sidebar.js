    ...
    return(<>
            <div className={"sidebar"}>
                <div className={"categoryMenu"}>
                    ...
                    <Link to={"/locationReservation"} className={"category " + ( color == 2 ? "active" : "" )}  onClick={(e)=>{changeColor( 2 )}}> 시설 예약 관리 </Link>
                    <Link to={"/roomManagement"} className={"category " + ( color == 3 ? "active" : "" )}  onClick={(e)=>{changeColor( 3)}}>객실 관리</Link>
                    <Link to={"/locationManagement"} className={"category " + ( color == 4 ? "active" : "" )}  onClick={(e)=>{changeColor( 4 )}}> 시설 관리 </Link>
